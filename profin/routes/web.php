    ...
    Route::group(['middleware' => $email_verification == 'enabled' ? ['auth', 'verified'] : ['auth']], function () {
        ...
        Route::group(['middleware' => ['Email2FA']], function () {
            ...
            Route::group(['middleware' => ['permission'], 'prefix' => 'admin'], function () {
                ...
                Route::get('search-user-name', 'ReportController@searchUserByName')->name('search.user.name');
                ...
                Route::match(['get', 'post'], 'reports/balance_sheet', 'ReportController@balance_sheet')->name('reports.balance_sheet');
