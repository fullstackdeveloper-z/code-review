<div class="sb-sidenav-menu-heading">{{ _lang('Home') }}</div>
...
<div class="sb-sidenav-menu-heading">{{ _lang('Accounts') }}</div>
...
<div class="sb-sidenav-menu-heading">{{ _lang('Transfer') }}</div>
...
<a class="nav-link" href="{{ route('other_banks.index') }}">
	...
	{{ _lang('External Banks') }}
</a>

<div class="sb-sidenav-menu-heading">{{ _lang('Products') }}</div>
...
{{--	</nav>--}}
{{--</div>--}}
<div class="sb-sidenav-menu-heading">{{ _lang('Support') }}</div>
...
<div class="sb-sidenav-menu-heading">{{ _lang('Reports') }}</div>
...
<a class="nav-link" href="{{ route('reports.balance_sheet') }}">
	<div class="sb-nav-link-icon"><i class="icofont-bank"></i></div>
	{{ _lang('Balance Sheet') }}
</a>
