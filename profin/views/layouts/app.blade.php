		...
		<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <div class="container-fluid">
				...
				<ul class="navbar-nav ml-auto ml-md-0">
					<li class="nav-item dropdown animate-dropdown">
						<a class="nav-link dropdown-toggle" id="languageSelector" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<i class="icofont-wallet"></i>
							{{ $sum }}</a>
						<div class="dropdown-menu dropdown-menu-right card-body" >
							@foreach($account_balance as $currency)
								{{ $currency->name.' '._lang('Balance') }}: <h6 class="pt-1"><b>{{ decimalPlace($currency->balance, currency($currency->name)) }}</b></h6>
							@endforeach
						</div>
					</li>
				</ul>
