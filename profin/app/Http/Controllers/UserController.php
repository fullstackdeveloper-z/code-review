...
//            Will Trying to Show Balance,
            ...
            // End Will trying to show balance.

            ->setRowId(function ($user) {
                return "row_" . $user->id;
            })
            ->rawColumns(['status', 'profile_picture', 'document_verified_at', 'email_verified_at', 'sms_verified_at', 'action','balance'])
            ->make(true);
    }
