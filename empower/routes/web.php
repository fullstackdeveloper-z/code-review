...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::get('/return-to-admin-dashboard', 'HomeController@loginAgainToAdmin')->name('return.to.admin.dashboard');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::group(['prefix' => 'bulk-upload/download'], function() {
        ...
        Route::get('/excel/category', 'ProductBulkUploadController@excel_download_category')->name('vexcel.download_category');
        Route::get('/excel/brand', 'ProductBulkUploadController@excel_download_brand')->name('vexcel.download_brand');
        Route::get('/excel/seller', 'ProductBulkUploadController@excel_download_seller')->name('vexcel.download_seller');

        Route::get('/excel/products', 'ProductBulkUploadController@excel_download_products')->name('vexcel.download_products');
    });
