...
@section('panel_content')
    ...
    <div class="row gutters-10">
        <div class="col-md-3">
            <div  class="bg-grad-3 text-white rounded-lg mb-4 overflow-hidden mb-3 c-pointer shadow-sm hov-shadow-xl has-transition">
                <a href="{{ route('seller.products') }}" class="text-white">
              <div class="px-3 pt-3">
                <div class="h3 fw-700">
        ...
        <div class="col-md-3">
            <div class="bg-grad-1 text-white rounded-lg mb-4 overflow-hidden mb-3 c-pointer shadow-sm hov-shadow-xl has-transition">
        ...
        <div class="col-md-3">
            <div class="bg-grad-2 text-white rounded-lg mb-4 overflow-hidden mb-3 c-pointer shadow-sm hov-shadow-xl has-transition">
                 <a href="{{ route('commission-log.index') }}" class="text-white">
                <div class="px-3 pt-3">
                    @php
