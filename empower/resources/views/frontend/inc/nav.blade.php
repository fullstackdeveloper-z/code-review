...
@if(!empty(session('adminId')))
    <div class="position-relative top-banner bg-danger z-1035 " >
        <a href="javascript::void(0)" class="d-block my-2 ml-4 text-reset">
           <span class="text-white"> Admin login as <strong>{{ auth()->user()->name }}</strong></span>
            {{-- <img src="{{ uploaded_asset(get_setting('topbar_banner')) }}" class="w-100 mw-100 h-50px h-lg-auto img-fit"> --}}
        </a>
        <a href="{{ route('return.to.admin.dashboard') }}" class="btn text-white absolute-top-right set-session" style="padding: 0.5rem;" >
            Return to Admin
        </a>
    </div>
@endif
            ...
            <div class="col-5 text-right d-none d-lg-block">
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    ...
                    @auth
                        @if(isAdmin())
                            <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                                <a href="{{ route('admin.dashboard') }}" class="text-reset d-inline-block opacity-60 py-2">{{ translate('Admin Panel')}}</a>
                            </li>
                            <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                                <a href="{{ route('admin.dashboard') }}" class="text-reset d-inline-block opacity-60 py-2">{{ translate('Return to Admin') }}</a>
                            </li>
                        ...
                        @else
                           ...
                           @if (get_setting('wallet_system') == 1)
                                <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                                    <a href="{{ route('wallet.index') }}" class="text-reset d-inline-block opacity-60 py-2">
                            ...
                            @endif
                            <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                                <a href="{{ route('dashboard') }}" class="text-reset d-inline-block opacity-60 py-2">{{ translate('Customer Panel')}}</a>
                            </li>
                           @elseif(Auth::user()->user_type == 'seller')
                            ...
                            <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                                    <a href="{{ route('withdraw_requests.index') }}" class="text-reset d-inline-block opacity-60 py-2">
                                       <i class="las la-money-check-alt"></i>
                                        <span>{{ single_price(Auth::user()->seller->admin_to_pay) }}</span>
                                    </a>
                                </li>

                            <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                                <a href="{{ route('dashboard') }}" class="text-reset d-inline-block opacity-60 py-2">{{ translate('Seller Panel')}}</a>
                            </li>
                            @endif
                    ...
                    @else
                        ...
                        <li class="list-inline-item">
                            <a href="{{ route('shops.create') }}" class="text-reset d-inline-block opacity-60 py-2">{{ translate('Be a Seller') }}</a>
                        </li>
                         @endif
    ...
    <div class="position-relative logo-bar-area z-1">
        <div class="container">
            <div class="d-flex align-items-center">
                ...
                <a href="{{ route('seller.products') }}" class="d-flex align-items-center text-reset">
                    <i class="las la-box la-2x opacity-80"></i>
                    <span class="flex-grow-1 ml-1">
                        ...
                        <!--@endif-->
                        <span class="nav-box-text d-none d-xl-block opacity-70">{{translate('Products')}}</span>
                    </span>
                </a>
                </div>
                 <div class="d-none d-lg-block ml-3 mr-0">
                ...
                <div class="d-none d-lg-block ml-3 mr-0">
                    ...
                    <a href="{{ route('poin-of-sales.seller_index') }}" class="d-flex align-items-center text-reset {{ areActiveRoutes(['poin-of-sales.seller_index'])}}">
                        <i class="la la-box la-2x opacity-80"></i>
                        <span class="flex-grow-1 ml-1">
                            <span class="nav-box-text d-none d-xl-block opacity-70">{{ translate('POS Manager') }}</span>
                        </span>
                    </a>
                    </div>
                            @endif
