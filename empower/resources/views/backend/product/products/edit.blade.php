                            ...
                            <div class="col-md-8">
                                ...
                                <select class="form-control aiz-selectpicker" size="6" name="parent_id" id="category_id" data-live-search="true" required>
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" @if(@$product->category->parentCategory->parentCategory->id == $category->id || $product->category_id == $category->id) selected  @endif  data-child = '{{ json_encode($category->childrenCategories) }}'  >{{ $category->getTranslation('name') }}</option>

                                        @if(@$product->category->parentCategory->parentCategory->id == $category->id)
                                            @php
