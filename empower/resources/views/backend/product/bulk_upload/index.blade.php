...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <br>
            <div class="">
                <a href="{{ route('vexcel.download_products') }}" ><button class="btn btn-info">{{ translate('Download CSV')}}</button></a>
            </div>
            <div class="alert" style="color: #004085;background-color: #cce5ff;border-color: #b8daff;margin-bottom:0;margin-top:10px;">
            ...
            <div class="">
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="{{ route('vexcel.download_category') }}">{{ translate('excel') }}</a>
                      <a class="dropdown-item" href="{{ route('pdf.download_category') }}">{{ translate('PDF') }}</a>
                    </div>
                </div>

                <div class="btn-group">
                    <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        {{translate('Download Brand')}}
                    </button>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="{{ route('vexcel.download_brand') }}">{{ translate('excel') }}</a>
                      <a class="dropdown-item" href="{{ route('pdf.download_brand') }}">{{ translate('PDF') }}</a>
                    </div>
                </div>

                <div class="btn-group">
                    <button class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        {{translate('Download Seller')}}
                    </button>
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="{{ route('vexcel.download_seller') }}">{{ translate('excel') }}</a>
                      <a class="dropdown-item" href="{{ route('pdf.download_seller') }}">{{ translate('PDF') }}</a>
                    </div>
                </div>
                {{-- pdf.download_seller --}}
