							...
							<div class="col-lg-8">
                                ...
                                <select class="form-control aiz-selectpicker" size="6" name="parent_id" id="category_id" data-live-search="true" required>
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}"  data-child = '{{ json_encode($category->childrenCategories) }}'  >{{ $category->getTranslation('name') }}</option>
                                    @endforeach
                                </select>

                                <div class="row ">
                                    <div class="col-sm-12 col-lg-6 pt-2">
                                        <select class="form-control " size="6" name="midCategoryId" id="midCategoryId" data-live-search="true" required>

                                        </select>
                                    </div>
                                    <div class="col-sm-12 col-lg-6 pt-2">
                                        <select class="form-control " size="6" name="lastCategoryId" id="lastCategoryId" data-live-search="true" required>
