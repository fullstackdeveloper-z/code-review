...
class FoodCategoryAddForm extends Component
{
    use WithFileUploads;
    public $name;
    ...
    public function render()
    {
        ...
        return view('livewire.admin.food-category.food-category-add-form');
    }

    public function updatedImage() {
        $this->validate([
            // 'name' => 'required',
            'image' => 'required|mimes:jpg,bmp,png,svg,jpeg|max:2056|dimensions:ratio=16/9',
        ],[
            // 'name.required' => 'Please enter the name (required)',
            'image.required' => 'Please choose image (required)',
    ...
    public function save() {
       ...
       // dd($this);
        ...
        if ($cate->save()) {
           ...
           session()->flash('error', 'Category not created successfully.'); 
        }
