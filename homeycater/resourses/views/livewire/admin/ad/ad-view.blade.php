@section('content')
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <!--begin::Subheader-->
        <livewire:admin.includes.sub-header :text="'Ad - View'" />
        <!--end::Subheader-->
        <!--begin::Entry-->
        <!--begin::Entry-->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex flex-column flex-grow-1">
                                                <a href="#" class="text-dark-75 text-hover-primary mb-1 font-size-lg font-weight-bolder">{{$ad->first_name}} {{$ad->last_name}}</a>
                                                <div class="d-flex">
                                                    <div class="d-flex align-items-center pr-5">
                                                        ...
                                                        <span class="text-muted font-weight-bold">Publish From {{ date("d M Y", strtotime($ad->publish_start_date)) }} </span>
                                                    </div>
                                                    <div class="d-flex align-items-center">
                                                        <span class="svg-icon svg-icon-md svg-icon-primary pr-1">
                                                            <!--begin::Svg Icon | path:assets/media/svg/icons/Home/Clock.svg-->
                                                        ...
                                                        <span class="text-muted font-weight-bold">Publish to {{ date("d M Y", strtotime($ad->publish_end_date)) }} </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--end::Info-->
                                        ...
                                        <div class="pt-3">
                                            <!--begin::Description-->
                                            <p class="text-dark-75 font-size-lg font-weight-normal pt-5"><b>1. Company </b> : {{ $ad->company }}  
                                            <br><b>2. Address </b> : {{ @$ad->address }}, {{ @$ad->city  }}, {{ @$ad->state  }}, {{ @$ad->country  }} 
                                            <br><b>3. Phone </b> : {{ @$ad->phone }} 
                                            <br><b>4. Email </b> : {{ @$ad->email }} 
                                            <br><b>5. IM Id </b> : {{ @$ad->im_id }} 
                                            <br><b>6. Comment  :</b>  {{ @$ad->comments }}
                                            <br><b>7. URL  :</b> <a href="{{ @$ad->url }}">{{ @$ad->url }}</a> 
                                            <br><b>8. Ad Type  :</b> {{ @$ad->type }}
                                            <br><b>8. Adable Type  :</b> {{ @$ad->adable_type =='App\Models\Video' ? 'Video': 'Image'}}</a> 
                                        ...
                                        <div class="pt-3">
                                            ...
                                            @if($ad->adable_type == 'App\Models\Photo') 
                                                <div class="bgi-no-repeat bgi-size-cover rounded min-h-295px" style="background-image: url({{asset('storage/').'/'.$adable_data->image}})">sdkfhnjksdfnk</div>
                                            @else
                                                <div class="bgi-no-repeat bgi-size-cover rounded min-h-295px">
                                                    <video width="320" height="240" controls src="{{asset('storage/'.$adable_data->video)}}"></video>
                                                </div>
                                ...
                                {{-- <div class="card card-custom gutter-b">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="position-relative">
                                            <textarea id="kt_forms_widget_9_input" class="form-control border-0 p-0 pr-10 resize-none" rows="1" placeholder="Any Question?" style="overflow: hidden; overflow-wrap: break-word; height: 19px;"></textarea>
