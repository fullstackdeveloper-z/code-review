...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    @php
        $addRoute = route('admin.food.dishes.add');
    @endphp
    <livewire:admin.includes.sub-header :text="'Food Dishes'" :addButton="$addRoute" />
    ...
    <div class="d-flex flex-column-fluid">
        ...
        <div class="container">
            ...
            @endif
            <livewire:admin.food-dish.food-dish-datatable />
        </div>
        <!--end::Container-->
    </div>
    <!--end::Entry-->
